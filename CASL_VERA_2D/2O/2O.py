...
FUEL_XS_NAMES = {"normal_fuel", "gd_fuel"}  # only fissionable materials carry kappa-fission data
...
label_to_block_xs = {
    ...
    "gd": (h5_mat_names.index("gd_fuel"), xs_dict["gd_fuel"]),
}
