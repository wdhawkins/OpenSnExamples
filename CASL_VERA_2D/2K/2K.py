...
FUEL_XS_NAMES = {"high_fuel", "low_fuel"}  # only fissionable materials carry "kappa-fission" data
...
label_to_block_xs = {
    "fuh": (h5_mat_names.index("high_fuel"), xs_dict["high_fuel"]),
    "ful": (h5_mat_names.index("low_fuel"), xs_dict["low_fuel"]),
}
